...
import (
	...
	appparams "github.com/amaurymartiny/step3/app/params"
	"github.com/amaurymartiny/step3/x/step3"
	step3keeper "github.com/amaurymartiny/step3/x/step3/keeper"
	step3types "github.com/amaurymartiny/step3/x/step3/types"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/step3d")
	}
...
type App struct {
	*baseapp.BaseApp
	...
	step3Keeper step3keeper.Keeper
...
func New(
	...
	app.step3Keeper = *step3keeper.NewKeeper(
		appCodec, keys[step3types.StoreKey], keys[step3types.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		step3.NewAppModule(appCodec, app.step3Keeper),
