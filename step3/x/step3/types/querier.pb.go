...
// source: step3/v1beta1/querier.proto
...
func init() {
	proto.RegisterType((*QueryAllCommentRequest)(nil), "blog.step3.v1beta1.QueryAllCommentRequest")
	proto.RegisterType((*QueryAllCommentResponse)(nil), "blog.step3.v1beta1.QueryAllCommentResponse")
	proto.RegisterType((*QueryAllPostRequest)(nil), "blog.step3.v1beta1.QueryAllPostRequest")
	proto.RegisterType((*QueryAllPostResponse)(nil), "blog.step3.v1beta1.QueryAllPostResponse")
}

func init() { proto.RegisterFile("step3/v1beta1/querier.proto", fileDescriptor_41dd67dbb03dcebd) }
...
func (c *queryClient) AllComment(ctx context.Context, in *QueryAllCommentRequest, opts ...grpc.CallOption) (*QueryAllCommentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blog.step3.v1beta1.Query/AllComment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AllPost(ctx context.Context, in *QueryAllPostRequest, opts ...grpc.CallOption) (*QueryAllPostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blog.step3.v1beta1.Query/AllPost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_AllComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blog.step3.v1beta1.Query/AllComment",
	}
...
func _Query_AllPost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blog.step3.v1beta1.Query/AllPost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "blog.step3.v1beta1.Query",
	...
	Metadata: "step3/v1beta1/querier.proto",
}
