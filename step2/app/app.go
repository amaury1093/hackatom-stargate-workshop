...
import (
	...
	appparams "github.com/amaurymartiny/step2/app/params"
	"github.com/amaurymartiny/step2/x/step2"
	step2keeper "github.com/amaurymartiny/step2/x/step2/keeper"
	step2types "github.com/amaurymartiny/step2/x/step2/types"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/step2d")
	}
...
type App struct {
	*baseapp.BaseApp
	...
	step2Keeper step2keeper.Keeper
...
func New(
	...
	app.step2Keeper = *step2keeper.NewKeeper(
		appCodec, keys[step2types.StoreKey], keys[step2types.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		step2.NewAppModule(appCodec, app.step2Keeper),
	...
	app.mm.SetOrderBeginBlockers(
		distrtypes.ModuleName, slashingtypes.ModuleName, stakingtypes.ModuleName,
	)
