...
func init() {
	proto.RegisterType((*MsgComment)(nil), "blog.step2.v1beta1.MsgComment")
	proto.RegisterType((*MsgPost)(nil), "blog.step2.v1beta1.MsgPost")
}

func init() { proto.RegisterFile("step2/v1beta1/tx.proto", fileDescriptor_a350a2457a140a1d) }
