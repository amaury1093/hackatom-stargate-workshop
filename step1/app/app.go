...
import (
	...
	appparams "github.com/amaurymartiny/step1/app/params"
	"github.com/amaurymartiny/step1/x/step1"
	step1keeper "github.com/amaurymartiny/step1/x/step1/keeper"
	step1types "github.com/amaurymartiny/step1/x/step1/types"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/step1d")
	}
...
type App struct {
	*baseapp.BaseApp
	...
	step1Keeper step1keeper.Keeper
...
func New(
	...
	app.step1Keeper = *step1keeper.NewKeeper(
		appCodec, keys[step1types.StoreKey], keys[step1types.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		step1.NewAppModule(appCodec, app.step1Keeper),
